var jsSubFolderEssentials = "essentials/", jsSubFolderExternal = "external/", jsSubFolderApi = "api/", jsSubFolderPages = "pages/", jsSubFolderModules = "modules/", jsSubFolderPlugins = "plugins/", jsSubFolderBundles = "jsbundles/", jsMinified = ".min";
try {
    Cookies.defaults = {path: "/", domain: window.universal_variable.page.cookieDomainName}
} catch (e) {
}
!function () {
    "use strict";
    function e() {
        var e, t = new Date;
        try {
            if (e = window.localStorage, "object" == typeof e)try {
                e.setItem(t, 1), e.removeItem(t), e.getItem(t)
            } catch (n) {
                _ = !1
            }
        } catch (n) {
    ...
    function c(e, t) {
        document.documentElement.className = document.documentElement.className.replace(e, t)
    }

    function a(e, t) {
        var n = document.createElement("style");
        document.getElementsByTagName("head")[0].appendChild(n), n.setAttribute("type", "text/css"), n.styleSheet ? n.styleSheet.cssText = e : n.textContent = e, 0 === t ? c(u, g) : c(h, S)
    }

    function i(e, t, n) {
        var o = document.createElement("link");
        o.href = e, o.rel = "stylesheet", o.type = "text/css", document.getElementsByTagName("head")[0].appendChild(o), navigator.cookieEnabled && (document.cookie = String(t)), 0 === n ? c(u, g) : c(h, S)
    }

    function s(e, t, c, s, l, r) {
        if (_ && window.XMLHttpRequest)if (o(localStorage[String(l)], r) || (localStorage.removeItem(String(c)), localStorage.removeItem(String(s)), localStorage.removeItem(String(l))), n(localStorage[String(c)], localStorage[String(s)], e))a(localStorage[String(c)], t); else {
            var d = new XMLHttpRequest;
            d.open("GET", e, !0), d.onreadystatechange = function () {
                4 === d.readyState && (200 !== d.status ? i(e, c, t) : (a(d.responseText, t), localStorage[String(c)] = d.responseText, localStorage[String(s)] = e, localStorage[String(l)] = r))
            }, d.send()
        } else i(e, c, t)
    }

    var l = jsMinified, r = staticInfo.staticFolder + "bundlecss/web-fonts" + l + ".css", d = staticInfo.staticFolder + "bundlecss/icongliphs" + l + ".css", f = staticInfo.fontVersion, m = staticInfo.fontIconsVersion, u = "js-no-font", g = "js-font", h = "js-no-icon", S = "js-icon", _ = !0;
    document.documentElement.className += " " + u + " " + h, "yes" === document.documentElement.accessKey && (r = "bundlecss/web-fonts-" + document.documentElement.lang + l + ".css"), e(), _ && localStorage.font_cache && o(localStorage.font_cache_version, f) || document.cookie.indexOf("font_cache") > -1 ? s(r, 0, "font_cache", "font_cache_file", "font_cache_version", f) : t(window, "load", function () {
        s(r, 0, "font_cache", "font_cache_file", "font_cache_version", f)
    }), _ && localStorage.icon_cache && o(localStorage.icon_cache_version, m) || document.cookie.indexOf("icon_cache") > -1 ? s(d, 1, "icon_cache", "icon_cache_file", "icon_cache_version", m) : t(window, "load", function () {
        s(d, 1, "icon_cache", "icon_cache_file", "icon_cache_version", m)
    })
}();
window.Modernizr = function (e, t, n) {
    ...
    function s() {
        p.input = function (n) {
            for (var r = 0, o = n.length; o > r; r++)F[n[r]] = n[r] in E;
            return F.list && (F.list = !!t.createElement("datalist") && !!e.HTMLDataListElement), F
        }("autocomplete autofocus list placeholder max min multiple pattern required step".split(" ")), p.inputtypes = function (e) {
            for (var r, o, i, a = 0, c = e.length; c > a; a++)E.setAttribute("type", o = e[a]), r = "text" !== E.type, r && (E.value = b, E.style.cssText = "position:absolute;visibility:hidden;", /^range$/.test(o) && E.style.WebkitAppearance !== n ? (h.appendChild(E), i = t.defaultView, r = i.getComputedStyle && "textfield" !== i.getComputedStyle(E, null).WebkitAppearance && 0 !== E.offsetHeight, h.removeChild(E)) : /^(search|tel)$/.test(o) || (r = /^(url|email)$/.test(o) ? E.checkValidity && E.checkValidity() === !1 : E.value != b)), k[e[a]] = !!r;
            return k
        }("search tel url email datetime date month week time datetime-local number range color".split(" "))
    }

    var u, d, f = "2.8.3", p = {}, m = !0, h = t.documentElement, v = "modernizr", y = t.createElement(v), g = y.style, E = t.createElement("input"), b = ":)", w = ({}.toString, " -webkit- -moz- -o- -ms- ".split(" ")), C = "Webkit Moz O ms", x = C.split(" "), T = C.toLowerCase().split(" "), S = {svg: "http://www.w3.org/2000/svg"}, N = {}, k = {}, F = {}, M = [], j = M.slice, $ = function (e, n, r, o) {
        var i, a, c, l, s = t.createElement("div"), u = t.body, d = u || t.createElement("body");
        if (parseInt(r, 10))for (; r--;)c = t.createElement("div"), c.id = o ? o[r] : v + (r + 1), s.appendChild(c);
        return i = ["&#173;", '<style id="s', v, '">', e, "</style>"].join(""), s.id = v, (u ? s : d).innerHTML += i, d.appendChild(s), u || (d.style.background = "", d.style.overflow = "hidden", l = h.style.overflow, h.style.overflow = "hidden", h.appendChild(d)), a = n(s, e), u ? s.parentNode.removeChild(s) : (d.parentNode.removeChild(d), h.style.overflow = l), !!a
    }, z = {}.hasOwnProperty;
    d = o(z, "undefined") || o(z.call, "undefined") ? function (e, t) {
        ...
        var n;
        return "ontouchstart" in e || e.DocumentTouch && t instanceof DocumentTouch ? n = !0 : $(["@media (", w.join("touch-enabled),("), v, ")", "{#modernizr{top:9px;position:absolute}}"].join(""), function (e) {
            n = 9 === e.offsetTop
        }), n
    ...
    for (var D in N)d(N, D) && (u = D.toLowerCase(), p[u] = N[D](), M.push((p[u] ? "" : "no-") + u));
    return p.input || s(), p.addTest = function (e, t) {
        ...
        var s, u, d = "3.7.0", f = e.html5 || {}, p = /^<|^(?:button|map|select|textarea|object|iframe|option|optgroup)$/i, m = /^(?:a|b|code|div|fieldset|h1|h2|h3|h4|h5|h6|i|label|li|ol|p|q|span|strong|style|table|tbody|td|th|tr|ul)$/i, h = "_html5shiv", v = 0, y = {};
        !function () {
            try {
        ...
        e.html5 = g, l(t)
    }(this, t), p._version = f, p._prefixes = w, p._domPrefixes = T, p._cssomPrefixes = x, p.testProp = function (e) {
        return a([e])
    }, p.testAllProps = l, p.testStyles = $, h.className = h.className.replace(/(^|\s)no-js(\s|$)/, "$1$2") + (m ? " js " + M.join(" ") : ""), p
...
!function (e, t) {
    ...
    var o = function (e) {
        ...
        return o._document = e.document, o._cacheKeyPrefix = "cookey.", o._maxExpireDate = new Date("Fri, 31 Dec 9999 23:59:59 UTC"), o.defaults = {
            ...
            return o._cachedDocumentCookie !== o._document.cookie && o._renewCache(), o._cache[o._cacheKeyPrefix + e]
        }, o.set = function (e, n, r) {
            return r = o._getExtendedOptions(r), r.expires = o._getExpiresDate(n === t ? -1 : r.expires), o._document.cookie = o._generateCookieString(e, n, r), o
            ...
            e = e.replace(/[^#$&+\^`|]/g, encodeURIComponent), e = e.replace(/\(/g, "%28").replace(/\)/g, "%29"), t = (t + "").replace(/[^!#$&-+\--:<-\[\]-~]/g, encodeURIComponent), o = o || {};
            var n = e + "=" + t;
            return n += o.path ? ";path=" + o.path : "", n += o.domain ? ";domain=" + o.domain : "", n += o.expires ? ";expires=" + o.expires.toUTCString() : "", n += o.secure ? ";secure" : ""
...
!function (e, t) {
    ...
    var ut, ct, ft, pt = /alpha\([^)]*\)/i, dt = /opacity\s*=\s*([^)]*)/, ht = /^(top|right|bottom|left)$/, gt = /^(none|table(?!-c[ea]).+)/, mt = /^margin/, yt = RegExp("^(" + fe + ")(.*)$", "i"), vt = RegExp("^(" + fe + ")(?!px)[a-z%]+$", "i"), bt = RegExp("^([+-])=(" + fe + ")", "i"), xt = {BODY: "block"}, Tt = {
        position: "absolute",
        visibility: "hidden",
        display: "block"
    }, wt = {
...
var events = {
    events: {}, on: function (e, t) {
        this.events[e] = this.events[e] || [], this.events[e].push(t)
    }, off: function (e, t) {
        if (this.events[e])for (var s = 0; s < this.events[e].length; s++)if (this.events[e][s] == t) {
